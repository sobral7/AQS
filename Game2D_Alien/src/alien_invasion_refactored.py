...
class AlienInvasion:
    ...
    def __init__(self):
        """Construtor da classe que inicializa o jogo e cria os recursos básicos[cite: 1]"""
        pygame.init()
    ...
    def _check_events(self):
        """Responde a eventos de pressionamento de teclas e mouse (fechamento da janela)[cite: 1]"""
    ...
    def _handle_keydown(self, event: pygame.event.Event) -> None:
        """Responde a eventos de pressionamento de teclas.[cite: 1]"""
    ...
    def _handle_keyup(self, event: pygame.event.Event) -> None:
        """Responde a eventos de soltura de teclas.[cite: 1]"""
        if event.key == pygame.K_RIGHT:
    ...
    def _update_game_state(self) -> None:
        """Atualiza a posição da nave, dos projéteis e dos alienígenas.[cite: 1]"""
        self.ship.update()
    ...
    def run_game(self) -> None:
        ...
        que o usuário decida fechar a janela.[cite: 1]
        """
